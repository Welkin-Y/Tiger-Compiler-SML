...
fun yyAction7 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (
    stringBuilder := !stringBuilder ^ "\\" ^ String.substring(yytext, 1, 3); 
    continue()
)
      end
fun yyAction8 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("illegal escaping character"); continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction52(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction52(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ61(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction52(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
              else yyAction52(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction27(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction27(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ61(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction52(strm, yyNO_MATCH)
                  else yyQ99(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
              else yyAction52(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction52(strm, yyNO_MATCH)
                  else yyQ103(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
              else yyAction52(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction34(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ105(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            ...
            if inp = #":"
              ...
              then if inp = #"\v"
                  ...
                  then if inp = #"\t"
                      ...
                      then yyQ9(strm', yyMATCH(strm, yyAction8, yyNO_MATCH))
